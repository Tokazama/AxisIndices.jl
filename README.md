...
* **Works with with Julia's standard library** (in progress). The end goal of AxisIndices is to fully integrate with the standard library wherever possible. The `Base`, `LinearAlgebra`, and `Statistics` are already heavily incorporated here.
