...
@testset "OffsetAxis" begin
    ...
    @test @inferred(OffsetAxis{Int16,SimpleAxis{Int16,Base.OneTo{Int16}}}(ks, inds)) ==
        OffsetAxis(Int16(1):Int16(3), Base.OneTo(Int16(3)))
    @test @inferred(OffsetAxis{Int16,SimpleAxis{Int16,Base.OneTo{Int16}}}(offset, inds)) ==
        OffsetAxis(Int16(1):Int16(3), Base.OneTo(Int16(3)))
...
getoffset(axis::AbstractAxis) = first(keys(axis)) - first(parent(axis))
