...
using AxisIndices: cat_axis, hcat_axes, vcat_axes

@testset "cat_axis" begin
    @test @inferred(cat_axis(Axis(UnitMRange(1, 10)), SimpleAxis(UnitMRange(1, 10))))       isa Axis{Int64,Int64,UnitMRange{Int64},UnitMRange{Int64}}
    @test @inferred(cat_axis(SimpleAxis(UnitMRange(1, 10)), SimpleAxis(UnitMRange(1, 10)))) isa SimpleAxis{Int64,UnitMRange{Int64}}
    @test @inferred(cat_axis(SimpleAxis(UnitMRange(1, 10)), Base.OneTo(10)))                isa SimpleAxis{Int64,UnitMRange{Int64}}
    @test @inferred(cat_axis(SimpleAxis(Base.OneTo(10)),    UnitMRange(1, 10)))             isa SimpleAxis{Int64,UnitMRange{Int64}}
    # FIXME Should be this
    #@test @inferred(cat_axis(Axis(Base.OneTo(10)),          UnitMRange(1, 10)))             isa Axis{Int64,Int64,OneToMRange{Int64},UnitMRange{Int64}}
    @test @inferred(cat_axis(Axis(Base.OneTo(10)),          UnitMRange(1, 10)))             isa Axis{Int64,Int64,Base.OneTo{Int64},UnitMRange{Int64}}
end
